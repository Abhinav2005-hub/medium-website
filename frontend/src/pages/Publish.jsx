      ...
      return (
        <div>
          ...
          <div className="flex justify-center w-full pt-2">
            <div className="max-w-screen-lg w-full px-4 space-y-3">  
              <input
              ...
              }} type="submit" className="mt-4 inline-flex item-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring:blue:900 hover:bg-blue-800">
                Publish post
              </button>
            </div>
          </div>
   ...
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 dark:border-gray-600 border-gray-200">
           ...
           <button type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded-sm cursor-pointer sm:ms-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
               <svg name="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 19 19">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea onChange={onChange} id="editor" rows="8" className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
       </div>
   </div>
</form>
    );
